...
objc-argument-list
    :   argument-list   COLON   objc-argument
    {
        $$ = $1 + " :" + $3;
    }
    |   argument-list   COLON   STAR   objc-argument
    {
        $$ = $1 + " :*" + $4;
    }
    |   argument-list   COLON   objc-argument
    ...
    |   argument-list   objc_method_literal  COLON   objc-argument
    {
        $$ = $1 + " " + $2 + ":" + $4;
    }
    |   argument-list   objc_method_literal  COLON   STAR   objc-argument
    {
        $$ = $1 + " " + $2 + ": *" + $5;
    }
    |   argument-list   objc_method_literal  COLON   objc-argument
...
objc-argument
    :   OPEN_PARENS CONST   STRUCT   expression CLOSE_PARENS
    {
        $$ = "(const struct "+$3+")";
    }
    |   OPEN_PARENS STRUCT expression CLOSE_PARENS
    {
        $$ = "(struct "+$2+")";
    }   
    ...
    |   OPEN_PARENS type local-rank-specifiers CLOSE_PARENS 
    {
        $$ = "(" +$1+ $2 +")";
    }   

...
"@public"                       return 'OBJC_PUBLIC';
"@private"                      return 'OBJC_PRIVATE';
"@protected"                    return 'OBJC_PROTECTED';
"@class"                        return 'OBJC_CLASS';
"@implementation"               return 'OBJC_IMPLEMENTATION';
"@interface"                    return 'OBJC_INTERFACE';
"@end"                          return 'OBJC_END';
"@selector"                     return 'OBJC_SELECTOR';
"@protocol"                     return 'OBJC_PROTOCOL';
"@optional"                     return 'OBJC_OPTIONAL';
"@required"                     return 'OBJC_REQUIRED';
"@throw"                        return 'OBJC_THROW';
"@synthesize"                   return 'OBJC_SYNTHESIZE';
"@property"                     return 'OBJC_PROPERTY';

"BOOL"                          return 'OBJC_BOOL';
"nil"                           return 'OBJC_NIL';
"id"                            return 'OBJC_ID';
